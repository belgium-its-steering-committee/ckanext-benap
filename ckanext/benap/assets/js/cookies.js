this.ckan.module('cookies', function (jQuery, _) {
    return {
        initialize: function () {
            ...
            if (checkboxF) {
                checkboxF.onclick = (event) => { labelText(event); };
            }
            const checkboxA = document.getElementById('analytical');
            if (checkboxA) {
                checkboxA.onclick = (event) => { labelText(event); };
            }
            const checkboxM = document.getElementById('marketing');
            if (checkboxM) {
                checkboxM.onclick = (event) => { labelText(event); };
            }
