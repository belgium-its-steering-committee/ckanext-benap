...
CYCLE_NETWORK_DATA = OrderedDict([
...
DYNAMIC_TRAFFIC_SIGNS_AND_REGULATIONS = OrderedDict([
...
FILLING_AND_CHARGING_STATIONS = OrderedDict([
...
FREIGHT_AND_LOGISTICS = OrderedDict([
...
GENERAL_INFORMATION_FOR_TRIP_PLANNING = OrderedDict([
...
PARKING_AREA_AND_REST_SERVICE_INFORMATION = OrderedDict([
...
PUBLIC_TRANSPORT_NON_SCHEDULED_TRANSPORT = OrderedDict([
...
PUBLIC_TRANSPORT_SCHEDULED_TRANSPORT = OrderedDict([
...
REAL_TIME_TRAFFIC_DATA = OrderedDict([
...
PEDESTRIAN_NETWORK_DATA = OrderedDict([
...
ROAD_EVENTS_AND_CONDITIONS = OrderedDict([
...
ROAD_WORK_INFORMATION = OrderedDict([
...
SHARING_AND_HIRING_SERVICES = OrderedDict([
...
STATIC_AND_ROAD_NETWORK_DATA = OrderedDict([
...
STATIC_TRAFFIC_SIGNS_AND_REGULATIONS = OrderedDict([
...
MOBILITY_THEME_BROADER = OrderedDict([
